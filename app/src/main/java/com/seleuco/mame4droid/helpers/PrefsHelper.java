...
public class PrefsHelper implements OnSharedPreferenceChangeListener {
    ...
    final static public String PREF_INPUT_EXTERNAL = "PREF_INPUT_EXTERNAL_3";
    ...
    final static public int PREF_INPUT_GENERAL_MULTI = 1;
    ...
    public void setIsNotMigrated(Boolean value) {
        SharedPreferences.Editor editor = getSharedPreferences().edit();
